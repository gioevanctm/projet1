    ...
    def analyse(self):
        try:
            if str(self.path_destination) == "PY_VAR11" or str(self.path_destination) == "":
                ...
                shutil.copy(str(self.path1prj), "C:\\Users\\" + os.getlogin() + "\\Documents\\Rapport\\shape_erreurs\\Erreurs_ZE_PMZ.prj") #récupération du fichier projection
                self.shp_err_pfsro = sf.Writer("C:\\Users\\" + os.getlogin() + "\\Documents\\Rapport\\shape_erreurs\\Erreurs_pf_PMZ", shapeType=1)
                shutil.copy(str(self.path2prj), "C:\\Users\\" + os.getlogin() + "\\Documents\\Rapport\\shape_erreurs\\Erreurs_pf_PMZ.prj") #récupération du fichier projection
                self.shp_err_zpbo = sf.Writer("C:\\Users\\" + os.getlogin() + "\\Documents\\Rapport\\shape_erreurs\\Erreurs_ZE_PB.shp", shapeType=5)
                shutil.copy(str(self.path3prj), "C:\\Users\\" + os.getlogin() + "\\Documents\\Rapport\\shape_erreurs\\Erreurs_ZE_PB.prj") #récupération du fichier projection
                self.shp_err_pfpbo = sf.Writer("C:\\Users\\" + os.getlogin() + "\\Documents\\Rapport\\shape_erreurs\\Erreurs_pf_PB.shp", shapeType=1)
                shutil.copy(str(self.path4prj), "C:\\Users\\" + os.getlogin() + "\\Documents\\Rapport\\shape_erreurs\\Erreurs_pf_PB.prj") #récupération du fichier projection
                self.shp_err_piq = sf.Writer("C:\\Users\\" + os.getlogin() + "\\Documents\\Rapport\\shape_erreurs\\Erreurs_logements.shp", shapeType=1)
                shutil.copy(str(self.path5prj), "C:\\Users\\" + os.getlogin() + "\\Documents\\Rapport\\shape_erreurs\\Erreurs_logements.prj") #récupération du fichier projection
                ...
                shutil.copy(str(self.path1prj), str(self.path_destination) + "\\Rapport\\Shape_erreurs\\Erreurs_ZE_PMZ.prj") #récupération du fichier projection
                self.shp_err_pfsro = sf.Writer(str(self.path_destination) + "\\Rapport\\Shape_erreurs\\Erreurs_pf_PMZ", shapeType=1)
                shutil.copy(str(self.path2prj), str(self.path_destination) + "\\Rapport\\Shape_erreurs\\Erreurs_pf_PMZ.prj") #récupération du fichier projection
                self.shp_err_zpbo = sf.Writer(str(self.path_destination) + "\\Rapport\\Shape_erreurs\\Erreurs_ZE_PB.shp", shapeType=5)
                shutil.copy(str(self.path3prj), str(self.path_destination) + "\\Rapport\\Shape_erreurs\\Erreurs_ZE_PB.prj") #récupération du fichier projection
                self.shp_err_pfpbo = sf.Writer(str(self.path_destination) + "\\Rapport\\Shape_erreurs\\Erreurs_pf_PB.shp", shapeType=1)
                shutil.copy(str(self.path4prj), str(self.path_destination) + "\\Rapport\\Shape_erreurs\\Erreurs_pf_PB.prj") #récupération du fichier projection
                self.shp_err_piq = sf.Writer(str(self.path_destination) + "\\Rapport\\Shape_erreurs\\Erreurs_logements.shp", shapeType=1)
                shutil.copy(str(self.path5prj), str(self.path_destination) + "\\Rapport\\Shape_erreurs\\Erreurs_logements.prj") #récupération du fichier projection
            ...
            self.title_ = ("SRO", "ZSROxSRO", "SROxZSRO", "Lgt Total", "Lgt Total données attributaires", "Différence",
            ...
            self.worksheet_PIQ = entete(self.workbook, "Rapport ZPBOxPIQ_Bal",
                                        "Cohérence des données Shape : ZPBO/PIQ_BAL")
            self._title_1 = (
            "PBO", "PIQxPBO", "Lgt données attributaires", "Différences", "Type Logement", "µModule\nZPBO",
            ...
            for a in set1:
                if a in set2:
                    ...
                    self.shp_err_zsro.shape(
                        self.shape_zsro[self.id_metier_zsro.index(a)])  # ecris le shape de l'index de l'id métier
            for b in set2:
                if b in set1:
                    ...
                    self.shp_err_pfsro.shape(
                        self.shape_pfsro[self.id_metier_pfsro.index(b)])  # ecris le shape de l'index de l'id métier
            # print("-----------------------------------------------------------------------------------------------------------------------------")
            ...
            for a in set3:
                if a in set4:
                    ...
                    self.shp_err_zpbo.shape(
                        self.shape_zpbo[self.id_metier_zpbo.index(a)])  # ecris le shape de l'index de l'id métier
            for b in set4:
                if b in set3:
                    ...
                    self.shp_err_pfpbo.shape(
                        self.shape_pfpbo[self.id_metier_pfpbo.index(b)])  # ecris le shape de l'index de l'id métier
            ...
            self.etat_prog.set("Le fichier excel est Ouvert, Fermez le et Réappuyer")
